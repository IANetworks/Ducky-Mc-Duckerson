...
public class WerewolfRoleCS extends CommandStructure {
     ...
     */
    public WerewolfRoleCS(SharedContainer container, String commandName, int commandID, int commandDefaultLevel) {
    ...
    public void execute(Member author, User authorUser, MessageChannel channel, Message message, String parameters, Map<String, CommandStructure> commandList) {
        ...
        if (hasPermission(author)) {
            if (ww.hasPlayer(guildID, author)) {
                ww.sendRole(guildID, author);
            }
        }
    }
