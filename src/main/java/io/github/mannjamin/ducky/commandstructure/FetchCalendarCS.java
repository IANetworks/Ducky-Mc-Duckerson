...
public class FetchCalendarCS extends CommandStructure {
     ...
     */
    public FetchCalendarCS(SharedContainer container, String commandName, int commandID, int commandDefaultLevel) {
    ...
    public String help(Long guildID, MessageChannel channel) {
        return localize(channel, "command.fetch_event.help");
    }
}
